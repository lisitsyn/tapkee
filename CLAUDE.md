...
# Build JavaScript/WebAssembly module (requires Emscripten)
...
- `BUILD_JS` - Build JavaScript/WebAssembly module (Emscripten only; ARPACK is skipped, Dense/Randomized eigensolvers are used)
