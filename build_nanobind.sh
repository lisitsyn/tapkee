...
g++ src/python/nanobind_extension.cpp -std=c++17 -fvisibility=hidden -I/usr/include/python3.12 -fPIC -I./include -I./src -I/usr/include/eigen3 -I/home/garcia/coding-challenges/ext/nanobind/include -I~/coding-challenges/ext/nanobind/ext/robin_map/include -Os -c -o build/src/python/nanobind_extension.o -ggdb  # debug
