...
#define CLEAR(TYPE,P) case TYPE: if (P) delete [] P; P = 0; break;
	...
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const char* list, int _size) : insensitive(0), op(_op), size(_size), 
	s1(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		s1 = new char[size];
		memcpy(s1, list, size);
	}
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned char* list, int _size) : insensitive(0), op(_op), 
	size(_size), u1(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		u1 = new unsigned char[size];
		memcpy(u1, list, size);
	}
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const short* list, int _size) : insensitive(0), op(_op), 
	size(_size), s2(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		s2 = new short[size];
		memcpy(s2, list, size*sizeof(short));
	}
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned short* list, int _size) : insensitive(0), op(_op), 
	size(_size), u2(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		u2 = new unsigned short[size];
		memcpy(u2, list, size*sizeof(unsigned short));
	}
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const int* list, int _size) : insensitive(0), op(_op), 
	size(_size), s4(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		s4 = new int[size];
		memcpy(s4, list, size*sizeof(int));
	}
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned int* list, int _size) : insensitive(0), op(_op), 
	size(_size), u4(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		u4 = new unsigned int[size];
		memcpy(u4, list, size*sizeof(unsigned int));
	}
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const long long* list, int _size) : insensitive(0), op(_op), 
	size(_size), s8(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		s8 = new long long[size];
		memcpy(s8, list, size*sizeof(long long));
	}
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned long long* list, int _size) : insensitive(0), op(_op), 
	size(_size), u8(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		u8 = new unsigned long long[size];
		memcpy(u8, list, size*sizeof(unsigned long long));
	}
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const float* list, int _size) : insensitive(0), op(_op), 
	size(_size), f(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		f = new float[size];
		memcpy(f, list, size*sizeof(float));
	}
	/* ------------------------------------------------------------------- */
	ezOptionValidator::ezOptionValidator(char _type, char _op, const double* list, int _size) : insensitive(0), op(_op), 
	size(_size), d(0), type(_type), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
		d = new double[size];
...
*/
	ezOptionValidator::ezOptionValidator(const char* _type, const char* _op, const char* _list, bool _insensitive) : insensitive(_insensitive), 
	op(0), size(0), t(0), type(0), quiet(0), id(0) {
		id = ezOptionParserIDGenerator::instance().next();
...
class OptionGroup {
	public:
		OptionGroup() : defaults(), delim(0), expectArgs(0), help(),
		isRequired(false), flags(), isSet(false), args(), parseIndex() { }
...
class ezOptionParser {
	public:
		...
		ezOptionParser() : overview(), syntax(), example(), footer(),
			optionGroupIds(), groups(), unknownArgs(), firstArgs(),
			lastArgs(), validators(), groupValidators()
		{
		...
		inline void add(const char * defaults, bool required, int expectArgs, 
				char delim, const char * help, const char * flag1, ezOptionValidator* validator=0);
		inline void add(const char * defaults, bool required, int expectArgs, 
				char delim, const char * help, const char * flag1, const char * flag2, ezOptionValidator* validator=0);
		inline void add(const char * defaults, bool required, int expectArgs, 
				char delim, const char * help, const char * flag1, const char * flag2, const char * flag3, ezOptionValidator* validator=0);
		inline void add(const char * defaults, bool required, int expectArgs, 
				char delim, const char * help, const char * flag1, const char * flag2, const char * flag3, const char * flag4, ezOptionValidator* validator=0);
...
void ezOptionParser::add(const char * defaults, bool required, int expectArgs, 
		char delim, const char * help, const char * flag1, ezOptionValidator* validator) {
...
/* ################################################################### */
void ezOptionParser::add(const char * defaults, bool required, int expectArgs, 
		char delim, const char * help, const char * flag1, const char * flag2, 
		const char * flag3, ezOptionValidator* validator) {
	int id = this->groups.size();
	OptionGroup * g = new OptionGroup;
	g->defaults = defaults;
	g->isRequired = required;
...
void ezOptionParser::add(const char * defaults, bool required, int expectArgs,
		char delim, const char * help, const char * flag1, const char * flag2, 
		const char * flag3, const char * flag4, ezOptionValidator* validator) {
	int id = this->groups.size();
	OptionGroup * g = new OptionGroup;
	g->defaults = defaults;
	g->isRequired = required;
